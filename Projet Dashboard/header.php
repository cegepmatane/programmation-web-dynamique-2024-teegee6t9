...
<head>
  ...
  <link rel="stylesheet" href="style/liste-heros.css?v=2" />
  <link rel="stylesheet" href="style/accueil.css?v=3" />
  <link rel="stylesheet" href="style/heros.css?v=3" />
  <?php if(!isset($titre)) $titre = "Accueil"; ?>
</head>
      ...
      <ul class="menu">
        ...
        <li>
          <a href="membre.php">
            ...
            ?>
              <img src="images/membres/<?= $_SESSION['membre']['avatar'] ?>" class="imagesHeader" alt="illustration">
              <p><?= $_SESSION['membre']['pseudonyme'] ?></p>
            <?php
            } else {
              echo '<i class="fa-solid fa-user-lock icone"></i> Me connecter';
            }
            ?>
          </a>
        </li>
