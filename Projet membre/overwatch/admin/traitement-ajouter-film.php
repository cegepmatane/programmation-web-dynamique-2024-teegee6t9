...
$SQL_AJOUTER_HEROS = "INSERT INTO `heros`(`nom`, `classe`, `pv`, `description_courte`, `habilite1`, `description_habilite1`, `habilite2`, `description_habilite2`, `ultimate`, `description_ultimate`, `description_longue`) VALUES ('" . $nom . "','" . $classe . "','" . $pv . "','" . $description_courte . "','" . $habilite1 . "','" . $description_habilite1 . "','" . $habilite2 . "','" . $description_habilite2 . "','" . $ultimate . "','" . $description_ultimate . "','" . $description_longue . "')";
...
if ($reussiteAjout) {
    ?>
    <div class="container">
        Votre héros a été ajouté à la base de données
    </div>
    <?php
} else {
